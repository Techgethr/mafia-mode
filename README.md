...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/techgethr/mafia-mode.git
   cd mafia-mode
   ```
...
3. Set up environment variables:
   Create a `.env` file (or clone the `.env.example` from _environment_ folder) in the root directory and add your OpenAI API key and Mode wallet private key:
   ```plaintext
...
#### Read Operations
- **get_balance**: Check wallet balances on the Mode testnet
...
3. **Blockchain Integration**:
   ...
   - Operations are executed on the Mode testnet
...
- Mode Network and the AI Agent Founder School program. 
